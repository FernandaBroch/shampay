...
public class ExcelToTransactionConverterTest {
    ...
    public void givenItauExtracCreateItauTransactions() {
        ...
        TransactionLine transactionLine1 = new TransactionLine(LocalDate.parse("11/12/2023", formatter), "PIX TRANSF ", new BigDecimal("100.0"), null, BudgetType.REALIZED, PaymentMethod.ITAU, 1L, "TestItauExtrato.xls");
        TransactionLine transactionLine2 = new TransactionLine(LocalDate.parse("18/12/2023", formatter), "REND PAGO APLIC AUT MAIS", new BigDecimal("0.71"), null, BudgetType.REALIZED, PaymentMethod.ITAU, 1L, "TestItauExtrato.xls");
